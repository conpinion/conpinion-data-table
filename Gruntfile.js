  ...
  grunt.initConfig({
    ...
    htmlbuild: {
      dist: {
        ...
        options: {
          scripts: {
            'conpinion-data-table': ['build/conpinion-data-table.js'],
            'conpinion-data-table-column': ['build/conpinion-data-table-column.js']
          },
          styles: {
            'conpinion-data-table': ['build/conpinion-data-table.css']
          },
          data: {
